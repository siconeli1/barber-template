...
- Socio: `admin` (senha demo: `1234`)
- Barbeiro comum: cadastre um barbeiro com cargo `barbeiro` no barbershop.config.ts
...
- Como socio, abrir [Agenda](app/admin/page.tsx) e confirmar que existe seletor de barbeiro.
...
- Como socio, abrir [Bloqueios](app/admin/bloqueios/page.tsx) e confirmar seletor de barbeiro.
...
- Como socio, abrir [Marcar horarios](app/admin/marcar/page.tsx) e confirmar seletor de barbeiro.
...
- Como socio, abrir [Financeiro](app/admin/financeiro/page.tsx) e confirmar acesso a `Visao geral da barbearia`.
...
- Como qualquer admin, abrir [Clientes](app/admin/clientes/page.tsx) e confirmar listagem geral.
...
- Como qualquer admin, abrir [Planos](app/admin/planos/page.tsx) e confirmar listagem de assinantes.
